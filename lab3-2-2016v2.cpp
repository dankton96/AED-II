    ...
    if(!db1.is_open())
        {
            if(!turma1.IsEmpty())
            {
                ...
                if(!db1.is_open()){cout<<"Erro ao criar banco de dados"; return;}
                else
                {
                    ...
                    db2<<turma2.name<<"\t"<<turma2.addres<<"\t"<<turma2.tel<<"\t"<<turma2.reg
                       <<"\t"<<turma2.height<<"\t"<<turma2.weight<<endl;
                    turma1.next->prev=turma1.act;
                    turma1.act=turma1.next;
                    }
                }
                db1.close();
            }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void ReadFromDB(Aluno turma2)
    {
        fstream db2;
        db2.open("database.txt");
        if(!db2.is_open()){cout<<"Erro ao criar banco de dados"; return;}
        else
        {
            /*
            if(db2.)
            {
                cout<<"O banco de dados está vazio";
            }
